...
const SiteDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const policy = {
      ...
      description,
      type: 'Site',
      createdSite: { id: selectedSite.id },
    };
  ...
  return (
    <div>
      <div className="bg-[#e5e7eb] mx-10 mt-8">
        <div className="relative overflow-x-auto shadow-md grid justify-sites-center">
            ...
            {sites &&
              sites.map((site, index) => (
                ...
                >
                  ...
                  <div className="basis-3/4">{site.name}</div>
                    ...
                    {site.orderLimit !== 0 ? (
                      ...
                      <div className="grid justify-items-end mr-6">
                        <button
                          ...
                          onClick={() => {
                            setShowForm(true), setSelectedSite(site);
                          }}
                        >
                          <img
                            src={plusIcon}
